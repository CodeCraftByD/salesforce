...
export default class SearchMentors extends NavigationMixin(LightningElement) {
  ...
  handleRetrieveMentors() {
    console.log(' $$ handleRetrieveMentors '+JSON.stringify(this.filterCategories));
    ...
    console.log(' $$ typeOfMentoring ',this.typeOfMentoring);
    console.log(' $$ functionalCompetencies ',this.functionalCompetencies);
    console.log(' $$ languages ',this.languages);
    console.log(' $$ experiences ',this.experiences);
    console.log(' $$ egcs ',this.egcs);
    console.log(' $$ greatCompetencies ',this.greatCompetencies);
